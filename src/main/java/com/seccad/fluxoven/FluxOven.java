...
public class FluxOven {
    ...
    public static final ItemGroup TAB = new ItemGroup("flux_oven_tab") {
        @Override
        @OnlyIn(Dist.CLIENT)
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ClientRegistry.bindTileEntityRenderer(TileInit.OVEN_PLATE_TILE.get(), OvenPlateRenderer::new);

            ScreenManager.register(ContainerInit.FLUX_OVEN_CORE_CONTAINER.get(), FluxOvenCoreScreen::new);
